...
perform_mortality_analysis <- function( matched_object,
  ...
  # data of cases
  matched_treated <- as.data.frame(matched_object[[2]])
  ...
  survival_matched_treated <- matched_treated %>%
  ...
  # combine treated and matched cohort
  survival_prop <- rbind(survival_matched_cohort, survival_matched_treated)
